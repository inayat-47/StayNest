...
const form = document.querySelectorAll(".delete-listing-review");
form.forEach(element => {
    element.addEventListener("submit", (e) => {
        ...
        Swal.fire({
            ...
            html: `<p class="fs-s">This action cannot be undone. This will permanently delete <strong class="fw-bold text-dark">
            ${element.dataset.title}</strong>${element.dataset.title === "the review." ? "" : " and all of its associated data and reviews.</p>"}`,
